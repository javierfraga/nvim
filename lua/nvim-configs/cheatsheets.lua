...
vim.cmd([[
  command! -nargs=0 CheatsheetMiscNormal
    ...
    \ | echo 'Move previous line first character                         normal! - (hyphen)'
    \ | echo 'Move current line first character                          normal! _ (underscore)'
    \ | echo 'Move next line first character                             normal! +'
...
vim.cmd([[
  command! -nargs=0 CheatsheetQuickfix
    ...
    \ | echo '   Note, this represents current buffer                    :%'
    \ | echo '   Note, this is an exact word match                       :\<pattern\>'
    \ | echo '   Note, \zs is start replacement string                   :\zs'
    \ | echo '   Note, \ze is start replacement string                   :\ze'
    \ | echo '   OR'
...
vim.cmd([[
  command! -nargs=0 CheatsheetWindowsResize
    ...
    \ | echo 'Incrementally decrease the windows height. CTRL-w 10 -     normal!  CTRL+w -'
    \ | echo 'Incrementally increase the windows height. CTRL-w 10 +     normal!  CTRL+w +'
